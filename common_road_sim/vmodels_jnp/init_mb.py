...
def init_mb(init_state, p):
    ...
    x0.append(delta0)  # steering angle of front wheel
    x0.append(np.cos(beta0) * vel0)  # velocity in x-direction
    ...
    x0.append(np.sin(beta0) * vel0)  # velocity in y-direction
    ...
    x0.append(np.sin(beta0) * vel0 + p["a"] * dotPsi0)  # velocity in y-direction front
    ...
    x0.append(np.sin(beta0) * vel0 - p["b"] * dotPsi0)  # velocity in y-direction rear
